...
public abstract class ActivityCodelet extends Codelet {
	 ...
	 *            Activity Codelet.
	 */
	public ActivityCodelet(String id, ArrayList<String> perceptualCodeletsIds, ArrayList<String> motivationalCodeletsIds,
			String motorCodeletId, String plannerCodeletId) {
		setName(id);
		this.id = id;
	...
	public void accessMemoryObjects() {
		...
		if(broadcastMemory == null) {
			broadcastMemory = this.getBroadcast(plannerCodeletId, index);
		}
